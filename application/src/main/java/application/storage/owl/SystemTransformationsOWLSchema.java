...
public class SystemTransformationsOWLSchema implements OWLSchema<SystemTransformations> {
	...
	private Individual combineSystemTransformation(SystemTransformation systemTransformation) {
	...
	public Individual combine(SystemTransformations object) {
		...
		for (SystemTransformation systemTransformation : object) {
			Individual ind_systemTransformation = combineSystemTransformation(systemTransformation);
	...
	public void connectOntologyModel(OntModel ontModel) {
		...
		objectProperty_hasSystemTemplate = ontModel
				.getObjectProperty(SystemTransformationsOWLModel.URI_hasSystemTemplate);
		objectProperty_isSystemTemplateOf = ontModel
				.getObjectProperty(SystemTransformationsOWLModel.URI_isSystemTemplateOf);
		objectProperty_hasTransformations = ontModel
				.getObjectProperty(SystemTransformationsOWLModel.URI_hasTransformations);
		objectProperty_areTransformationsOf = ontModel
				.getObjectProperty(SystemTransformationsOWLModel.URI_areTransformationsOf);
