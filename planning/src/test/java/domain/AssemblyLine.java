...
public class AssemblyLine {
	...
	public static Element rotateRobotToTransportLine() {
		...
		SystemObject robot = new SystemObject(OBJECT_PICK_AND_PLACE_ROBOT, "#ID-1");
		SystemObject station = new SystemObject(OBJECT_CONFIGURATION_STATION, "#ID-2");
		SystemObject line = new SystemObject(OBJECT_TRANSPORT_LINE, "#ID-3");
		...
		robot.addAttribute(new Attribute(ATTRIBUTE_GRAB, "открыт"));
